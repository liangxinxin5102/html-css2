...
<div id="welcome-panel" class="about-wrap">
	...
	<p class="about-text"> '.wp_get_theme().' is a free premium WordPress theme. This is a tumblog style theme. The theme uses WordPress post format feature to create posts with different formats like, image, audio, video, link, aside, gallery, quote etc. </p>
		...
		<ol>
			...
			<li><a href="https://github.com/crowdfavorite/wp-post-formats">WP post format ui</a></li>
		</ol>
		</div>
		...
		Ads your social media url via theme option page to enable social media buttons on the theme.</p>
