...
$example_update_checker = new ThemeUpdateChecker(
	'Sentoz',                                            //Theme folder name, AKA "slug". 
	'http://www.fabthemes.com/versions/sentoz.json' //URL of the metadata file.
); 
...
function web2feel_setup() {
	 ...
	 */
	add_theme_support( 'post-formats', array( 'gallery','aside', 'image', 'video', 'quote', 'link','audio' ) );
...
function web2feel_scripts() {
	...
	wp_enqueue_style( 'fontawesome-ie7', get_template_directory_uri() . '/css/font-awesome-ie7.css');
