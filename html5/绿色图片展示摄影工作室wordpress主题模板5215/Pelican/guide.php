...
<div id="welcome-panel" class="about-wrap">
	...
	<p class="about-text"> '.wp_get_theme().' is a free premium WordPress theme. This is a WordPress 3+ ready theme with features like custom menu, Custom welcome message box , widgetized sidebar etc. Theme also comes with an option panel. The homepage of the theme has a jQuery image gallery. </p>
		...
		There is a welcome section on the homepage. You can adjust the page message title and text via the option page.</p>
