...
<?php else : ?>
     ...
     <ul>
     <li><input name="author" type="text" class="input" value="Name" onfocus="if(this.value==defaultAuthor)this.value='';" onblur="if(this.value==''){this.value=defaultAuthor;}"></li>
...
<?php endif; ?>
     <li><textarea name="comment" cols="" rows="" class="textarea" onfocus="if(this.value==defaultComment)this.value='';" onblur="if(this.value==''){this.value=defaultComment;}" onpropertychange="if(value.length&gt;1000) value=value.substr(0,1000)">Content...</textarea></li>
	 <li> <input type="hidden" id="comment_parent" name="comment_parent" value="0"></li></ul>
	 <a class="bnt" onfocus="this.blur()" href="javascript:commentform_submit();">Sent </a>
