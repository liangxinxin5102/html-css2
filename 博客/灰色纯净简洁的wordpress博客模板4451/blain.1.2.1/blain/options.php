...
function optionsframework_options() {
	...
	$options[] = array(
		'desc' => __('Blain WordPress theme has been Designed and Created by <a href="http://InkHive.com" target="_blank">Rohit Tripathi</a>. For any Queries or help regarding this theme, <a href="#forums/section/theme-support/blain/" target="_blank">use the support forums.</a> You can also ask questions about this theme on WordPress.org Support Forums. I will answer your queries there too.', 'options_framework_theme'),
		'type' => 'info');	
